...
public class StandaloneAnalysisAPISessionBuilder(
    ...
    public fun build(): StandaloneAnalysisAPISession {
        ...
        StandaloneProjectFactory.registerServicesForProjectEnvironment(
            ...
            modules,
            ktModuleProviderImpl.allSourceFiles(),
            compilerConfiguration.languageVersionSettings,
            compilerConfiguration.get(JVMConfigurationKeys.JDK_HOME)?.toPath(),
        )

        registerApplicationServices()

        val project = kotlinCoreProjectEnvironment.project
        val ktFiles = getPsiFilesFromPaths<KtFile>(project, getSourceFilePaths(compilerConfiguration))
